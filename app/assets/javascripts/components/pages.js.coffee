{div, h1, p, span, a, strong, img, h2, script} = React.DOM
  ...
  componentWillMount: ->
    ...
    scripta.text =
      "function initMap() {
              ...
              var image = {
                url: 'assets/chilli.png',
                scaledSize: new google.maps.Size(30, 66),
  ...
  render: ->
    div null,
      div className: 'page main',
        ...
        img className:'chilli', src:'/assets/chilli.png'
        img className:'flower', src:'/assets/flower.png'
        img className:'rock', src:'/assets/rock.png'
      div className: 'page details',
        ...
        div className: 'address',
          ...
          p null, 'EH3 9BP'
        div id:'map'
        img className:'grapefruit', src:'/assets/grapefruit.png'
        img className:'lemon', src:'/assets/lemon.png'
        img className:'blob', src:'/assets/blob.png'
      div className: 'page transport',
        ...
        img className:'banana', src:'/assets/banana.png'
