{div, a, span, svg, g, animate, text, path} = React.DOM
...
@Pages = React.createClass
  ...
  render: ->
    div className: 'page',
      ...
      svg id:"yellow", className:"pane yellow", version:"1.0", xmlns:"http://www.w3.org/2000/svg", width:"355pt", height:"284pt", viewBox:"0 0 355 284", preserveAspectRatio:"xMidYMid meet",
        g id:"yellow-1", transform:"translate(0,284) scale(0.1,-0.1)", stroke:"none",
          path d: @state.yellow, onMouseOver: @handleYellowMouseOver, onMouseOut: @handleYellowMouseOut
        g id:"yellow-expanded", style:{display: "none"}, transform:"translate(0,284) scale(0.1,-0.1)", stroke:"none",
          path d: @state.yellowExpanded
